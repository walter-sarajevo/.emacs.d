...
(set-variable 'ycmd-server-command (quote ("python" "/home/walter/git/ycmd/ycmd")))  
(set-variable 'ycmd-global-config "/home/walter/git/ycmd/cpp/ycm/.ycm_extra_conf.py")  
...
;; (require 'pyim)
;; (setq pyim-dicts
;;       '((:name "bigdict" :file "/home/walter/.emacs.d/addons/pyim-bigdict.txt" :coding utf-8-unix))) 
